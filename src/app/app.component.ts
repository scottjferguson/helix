...
import { HelixSplashScreenService } from '@helix/services/splash-screen.service';
...
export class AppComponent implements OnInit, OnDestroy
{
     ...
     * @param {HelixSplashScreenService} _helixSplashScreenService
    ...
    constructor(
        ...
        private _helixSplashScreenService: HelixSplashScreenService,
    ...
    )
    {
        ...
        this._helixNavigationService.register('main', this.navigation);

        // Set the main navigation as our current navigation
        this._helixNavigationService.setCurrentNavigation('main');

        // Add languages
        this._translateService.addLangs(['en', 'es', 'tr']);

        // Set the default language
        this._translateService.setDefaultLang('en');

        // Set the navigation translations
        this._helixTranslationLoaderService.loadTranslations(navigationEnglish, navigationSpanish, navigationTurkish);
    ...
    ngOnInit(): void
    {
        ...
        this._helixConfigService.config
            ...
            .subscribe((config) => {
                ...
                // Boxed
                if ( this.helixConfig.layout.width === 'boxed' )
                {
                ...
                this.document.body.classList.add(this.helixConfig.colorTheme);
            });
    }
    ...
    {
        this._helixSidebarService.getSidebar(key).toggleOpen();
    }
}
