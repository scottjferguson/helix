...
export class DocsComponentsNavigationComponent
{
    ...
    showHideCalendarMenuItem(): void
    {
        ...
        this._helixNavigationService.updateNavigationItem('calendar', {
            hidden: this.hidden
        });
    }
    ...
    updateMailBadge(): void
    {
        ...
        this._helixNavigationService.updateNavigationItem('mail', {
                badge: {
                    title: 35
                }
        });
    ...
    addNavItemWithCustomFunction(): void
    {
        ...
        this._helixNavigationService.addNavigationItem(newNavItem, 'start');
    }
    ...
    {
        this._helixNavigationService.removeNavigationItem('dashboards');
    }
    ...
    registerNewNavigationAndToggle(): void
    {
        ...
        this._helixNavigationService.register('admin-nav', adminNav);

        // Set the current navigation
        this._helixNavigationService.setCurrentNavigation('admin-nav');
    }
}
