...
import { helixAnimations } from '@helix/animations/index';
import { HelixCopierService } from '@helix/services/copier.service';
...
export class ExampleViewerComponent implements AfterViewInit, OnDestroy
{
     ...
     * @param {HelixCopierService} _helixCopierService
     * @param {ComponentFactoryResolver} _componentFactoryResolver
     */
    /*constructor(
        private _matSnackBar: MatSnackBar,
        private _helixCopierService: HelixCopierService,
    ...
    {
        if ( this._helixCopierService.copyText(text) )
        {
