...
import { HelixSidebarService } from './sidebar.service';
...
export class HelixSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._helixConfigService.config
            ...
            .subscribe((config) => {
                this._helixConfig = config;
            });

        // Register the sidebar
        this._helixSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._helixSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('helix-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('helix-sidebar-overlay-invisible');
        }
