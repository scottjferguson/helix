...
import { MatColors } from '@helix/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const HELIX_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => HelixMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'helix-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : helixAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [HELIX_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class HelixMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, helix-navy-700 etc.)
