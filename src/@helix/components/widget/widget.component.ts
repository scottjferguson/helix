...
@Component({
    selector     : 'helix-widget',
    templateUrl  : './widget.component.html',
    styleUrls    : ['./widget.component.scss'],
    encapsulation: ViewEncapsulation.None
})

export class HelixWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(HelixWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<HelixWidgetToggleDirective>;
