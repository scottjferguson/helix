...
@Component({
    selector     : 'helix-theme-options',
    templateUrl  : './theme-options.component.html',
    styleUrls    : ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : helixAnimations
})
export class HelixThemeOptionsComponent implements OnInit, OnDestroy
{
    helixConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void
    {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._helixConfigService.config = config;
            });
        ...
        this._helixNavigationService.addNavigationItem(customFunctionNavItem, 'end');
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._helixNavigationService.removeNavigationItem('custom-function');
    }
            ...
            case 'vertical-layout-1':
            {
                this.form.patchValue({
                    layout: {
                        width    : 'fullwidth',
                        navbar   : {
                            primaryBackground  : 'helix-navy-700',
                            secondaryBackground: 'helix-navy-900',
                            folded             : false,
                            hidden             : false,
                            position           : 'left',
                        ...
                        toolbar  : {
                            background           : 'helix-white-500',
                            customBackgroundColor: false,
                            hidden               : false,
                            position             : 'below-static'
                        },
                        footer   : {
                            background           : 'helix-navy-900',
