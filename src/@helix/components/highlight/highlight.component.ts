...
import '@helix/components/highlight/prism-languages';

@Component({
    selector : 'helix-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class HelixHighlightComponent implements OnInit, OnDestroy
{
    // Source
    @ContentChild('source')
    source: ElementRef;
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using helix-highlight
        // component
