...
export class HelixInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {HelixMatchMediaService} _helixMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _helixMediaMatchService: HelixMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._helixMediaMatchService.onMediaChange
